...
const navItems = [
  ...
  { name: 'Laboratory', path: '/laboratory', icon: TestTubeIcon },
  ...
  { name: 'Nursing', path: '/nursing', icon: UserGroupIcon },
  { name: 'Operation Theatre', path: '/operation-theatre', icon: ScissorsIcon },
  ...
  { name: 'Radiology', path: '/radiology', icon: XRayIcon },
  { name: 'Reports', path: '/reports', icon: ChartBarIcon },
  { name: 'Social Service', path: '/social-service', icon: UserGroupIcon },
  ...
  { name: 'Vaccination', path: '/vaccination', icon: SyringeIcon },
